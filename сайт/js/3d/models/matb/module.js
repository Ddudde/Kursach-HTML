...
function init() {
	...
	const onLoadMtl = function ( mtlParseResult ) {
		...
		objLoader2.load( './js/3d/models/matb/MAXIMUS VI Formula.obj', callbackOnLoad, null, null, null );
	};
	const mtlLoader = new MTLLoader();
	mtlLoader.load( './js/3d/models/matb/MAXIMUS VI Formula.mtl', onLoadMtl );
